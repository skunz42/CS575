...
LOW_DENSITY_STATES = ['WA', 'KY', 'TX', 'WI', 'LA', 'AL', 'MO', 'WV', 'MN', 'VT', 'MS', 'AR', 'OK', 'IA', 'CO', 'ME', 'OR', 'UT']
VERY_LOW_DENSITY_STATES = ['AZ', 'KS', 'NV', 'NE', 'ID', 'NM', 'SD', 'ND', 'MT', 'WY', 'AK']
...
def write_to_csv(edges, csv_name):
    with open(csv_name, 'w', newline='') as csv_file:
        ...
        for e in edges:
            writer.writerow([e['start'], e['end'], e['distance'], e['population'], e['weight']])
